...
def is_shooting_star(index, data):
    ...
    prev_body = prev_close - prev_open > 5
...
def is_hammer(index, data):
    ...
    prev_body = prev_open - prev_close > 5
...
def is_bearish_engulfing(index, data):
    ...
    return (open >= prev_close - 2 and prev_close > prev_open and
            open > close and valid_body and
            prev_low > close and 
            open - close > prev_close - prev_open and prev_high > prev_high_2 > prev_high_3)
...
def is_bullish_engulfing(index, data):
    ...
    return (close >= prev_open > prev_close and
            ...
            prev_high < close  and
            close - open > prev_open - prev_close and prev_low > prev_low_2 > prev_low_3)
